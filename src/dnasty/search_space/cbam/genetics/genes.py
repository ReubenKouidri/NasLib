...
class ChannelAttentionGene(GeneBase):
    ...
    def __init__(self, se_ratio: int, in_channels: int = 1):
        se_ratio = validate_feature(
            "se_ratio", se_ratio, ChannelAttentionGene._feature_ranges["se_ratio"]
        )
...
class CBAMGene(GeneBase):
    ...
    def __init__(
        self, channel_gene: ChannelAttentionGene, spatial_gene: SpatialAttentionGene
    ):
        """
        ...
        super().__init__(
            {
                "in_channels": channel_gene.in_channels,
