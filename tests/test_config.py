...
class TestConfig(unittest.TestCase):
    ...
    def test_mapping_input(self):
        ...
        self.assertEqual(config_obj.__data, {'key1': 'value1', 'key2': 10})

    def test_nested_mapping_input(self):
        config_obj = Config({'outer': {'inner': '20.5'}})
        self.assertIsInstance(config_obj.outer, Config)
        self.assertEqual(config_obj.outer.__data, {'inner': 20.5})

    def test_string_conversion(self):
        config_obj = Config({'int_value': '10', 'float_value': '20.5', 'none_value': 'None', 'str_value': 'text'})
